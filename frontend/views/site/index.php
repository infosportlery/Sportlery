    ...
    <div class="mailing col-md-6 col-md-offset-3">
         ...
         <?php if(Yii::$app->language == 'nl'){?>
          <!--Zoho  Web-Optin Form Starts Here-->
            ...
            <div id="customForm">
              <div style="overflow: hidden; margin: 0px auto; background-color: rgb(255, 255, 255); padding: 0px; border-width: 1px; border-style: solid; border-color: rgb(255, 255, 255); border-radius: 1px; width: 60%;" name="SIGNUP_BODY" id="SIGNUP_PAGE">
